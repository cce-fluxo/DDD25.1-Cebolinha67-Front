    ...
    export default function HeaderSignIn(){
        ...
        return(
            ...
            <nav className="flex items-center gap-15">
                ...
                <button onClick={() => router.push("/sw/consulta/ver-consultas-realizadas")} className="bg-indigo-100 text-indigo-700 font-medium px-4 py-2 rounded-lg cursor-pointer "><img src={"/homeicon.png"}></img></button>
